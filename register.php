...
// (3) Return all form values by cookie from server to client (register.php) if user name exist.---->programming on half way.
//-----------------------------------------------------
    session_start();
    ...
    if(isset($_SESSION['UserIdExist'])){
        $msg="The user name you set has been used! \\nPlease try a new user Name.";
            ...
            <table id="tb">
                ...
                <tr>
                    ...
                    <td style="padding:20px 5px";>
                        <input type="button" value="Register" class="butn btn-info" form="fm1" onclick="isAllInputOk()"/>
                </form>
                <span style="float:right; margin-right:15px">
                    <form method="POST" id="fm2" action="">
                        <input type="button" name="cancel" value="Cancel" class="butn btn-info " form="fm2" onclick="resetForm()"/>
                    </form>
                </span>
                </td>
                </tr>
