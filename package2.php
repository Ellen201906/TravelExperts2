     ...
     <img class="main" src="polynesian16.jpg">
      ...
      <div class="destination-info-box">
        ...
        <!-- this part is for the rating stars. i created class to costumes the stars, like coloring the stars  -->
          ...
          <button type="submit" name="2" class="button btn btn-info  btn-link">Book</button>
           </form>
...
<div >
  <button class=" btn btn-info btn-link" style="width:243px;color:white" onclick="openCity(event, 'photos')">PHOTOS</button>
  <button class=" btn btn-info btn-link" style="width:243px;color:white" onclick="openCity(event, 'DESCRIPTION')">DESCRIPTION</button>
  <button class=" btn btn-info btn-link" style="width:243px;color:white" onclick="openCity(event, 'ITINERARY DETAILS')">ITINERARY DETAILS</button>
</div>
