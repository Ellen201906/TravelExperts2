...
the tab uses javascript functions therefore i commented on the javascript page about the function use-->
    ...
    <div >
      <button class=" btn btn-info btn-link" style="color:white;width:243px" onclick="openCity(event, 'photos')">PHOTOS</button>
      <button class=" btn btn-info btn-link"  style="color:white;width:243px" onclick="openCity(event, 'DESCRIPTION')">DESCRIPTION</button>
      <button class=" btn btn-info btn-link"  style="color:white;width:243px"onclick="openCity(event, 'ITINERARY DETAILS')">ITINERARY DETAILS</button>
    </div>
